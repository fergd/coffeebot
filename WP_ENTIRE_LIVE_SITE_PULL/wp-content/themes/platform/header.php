...
<meta name="google-site-verification" content="84fvHWCej-Mw9bVXU5M1vf01nPfht4Zc2iJqEgyxgzo" />
...
<body <?php body_class( $body_classes ); ?>>
	...
	<div id="site" class="<?php echo pagelines_layout_mode();?>"> <!-- #site // Wraps #header, #page-main, #footer - closed in footer -->
		...
		<div id="page"> <!-- #page // Wraps #header, #page-main - closed in footer -->
			...
			<div id="header" class="container-group fix" style="background-color:#efecc2;">
				<div class="outline">
